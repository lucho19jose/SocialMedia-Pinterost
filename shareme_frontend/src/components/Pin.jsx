...
const Pin = ( { another, pin: { postedBy, image, _id, destination, save } }) => {

  //console.log("pin id", _id);
  ...
  return (
    <div className='m-2'>
      ...
      >
        ...
        { postHovered && (
          <div 
            className='absolute top-0 w-ful h-full flex flex-col justify-between p-1 pr-2 pt-2 pb-2 z-50'
            style={{ height: '100%' }}
          >
            ...
            <div className='flex justify-center items-center gap-2 w-full'>
              { destination && (
                ...
                >
                  ...
                  { destination.length > 18 ? `${destination.slice(0,15)}...` : destination }
